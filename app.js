...
function renderDiary(){
 ...
 el.innerHTML=`<style>
 .diary-appt.deposit-due{background:#f6dada!important;border-color:#e7b4b4!important}
 .diary-appt.deposit-paid{background:#dcefdc!important;border-color:#b7d8b7!important}
 .diary-appt.customer-update{background:#fae2c9!important;border-color:#e8bd91!important}
 .diary-appt.status-completed{background:#eadff2!important;border-color:#ceb9dd!important}
 .diary-appt.status-closed{background:#e9e5e3!important;border-color:#cec7c3!important}
 .diary-colour-key{display:flex;gap:11px;flex-wrap:wrap;align-items:center;font-size:11px}
 .diary-colour-key span{display:inline-flex;align-items:center;gap:5px;white-space:nowrap}
 .diary-colour-key i{width:10px;height:10px;border-radius:50%;display:inline-block;border:1px solid rgba(0,0,0,.12)}
 .key-due{background:#f6dada}.key-paid{background:#dcefdc}.key-update{background:#fae2c9}.key-completed{background:#eadff2}.key-closed{background:#e9e5e3}
 @media(max-width:900px){.diary-colour-key{gap:6px;font-size:9px}}
